...
//     try {
//         const attachmentsInfo = processAttachments(state.attachments);
//         const locationInfo = state.location ? JSON.stringify(state.location) : null;
//         let allDetails = [];
...
//                 JSON.stringify([]), // Inicialmente vacío, se actualizará después
//                 locationInfo,
//                 from,
...
//                     if (attachment.type === 'text') {
//                         allDetails.push(attachment.content);
...
//                                 mediaId: attachment.mediaId,
//                                 caption: attachment.caption || '',
//                                 url: mediaUrl // Incluimos la URL en el objeto del attachment
//                             });
//                             if (attachment.caption) {
//                                 allDetails.push(attachment.caption);
//                             }
//                         } catch (error) {
...
//                 const finalDetails = allDetails.join('\n');
...
//                                 delete conversationState[from];
//                                 // Después de guardar exitosamente el PQRS, enviar notificación
...
//                                         [
//                                             state.pqrsId,
//                                             'Pendiente', // o mantener el estado actual
//                                             newDetails,
...
//                                                 const mediaCount = newProcessedAttachments.filter(a => a.type !== 'text').length;
//                                                 if (mediaCount > 0) {
